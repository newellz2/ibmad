...
impl port_info {
    ...
    bitfield!(
        link_down_default_state,
        set_link_down_default_state,
        268,
        4,
        u8
    );
    ...
    bitfield!(
        m_key_protect_bits_ext,
        set_m_key_protect_bits_ext,
        274,
        3,
        u8
    );
    ...
    bitfield!(
        partition_enforcement_inbound,
        set_partition_enforcement_inbound,
        348,
        1,
        u8
    );
    bitfield!(
        partition_enforcement_outbound,
        set_partition_enforcement_outbound,
        349,
        1,
        u8
    );
    ...
    bitfield!(
        multicast_pkey_trap_suppression,
        set_multicast_pkey_trap_suppression,
        409,
        2,
        u8
    );
    ...
    bitfield!(
        enhanced_qos_arbiter_enabled,
        set_enhanced_qos_arbiter_enabled,
        417,
        1,
        u8
    );
    ...
    bitfield!(
        link_speed_ext_supported,
        set_link_speed_ext_supported,
        500,
        4,
        u8
    );
